rule concordance_NA12878:
	...
	output:
		os.path.join(intermediate_path, "single_calling/concordance_NA12878/{sample}.tsv")
	conda:
		"../envs/gatk.yaml"
	log:
		os.path.join(intermediate_path, "log/single_calling/concordance_NA12878/{sample}.log")
	shell:
		"""
		gatk Concordance \
			-R {input.ref} \
